...
<div class="content">
    ...
    <div class="right">
        ...
        <!-- 注册成功 -->
        <div id="reg-suc" style="display:none;">
            <div class="rs-icon">
                <i class="syy icon-kaixin rs-big"></i>
                <input type="hidden" id="regUrl" value="<?php echo U('Sms/useSendSms');?>">
                <input type="hidden" id="SmsUrl" value="<?php echo U('Sms/useSendSms');?>">
                <!--<div class="rs-text">-->
                    <!--<span>恭喜您注册成功!</span>-->
                <!--</div>-->
                <div class="rs-btn">
                    <a href="<?php echo U('fregister');?>"><span class="rs-btni">成为分销商</span></a>
