...
<body>
    ...
    <ul class="module">
        ...
        <li class="module-item" style="display:none">
            <a href="/index.php/Weixin/Index/s_hotel">
                <i class="syy icon-icon36"></i>特惠酒店</a>
        </li>
        <li id="dataType" class="module-item on" data-type="TickList">
            <i class="syy icon-menpiao1"></i>景点门票</li>
    </ul>
    <div class="search-box">
        <div class="search-content">
            ...
            <input type="text" id="searchInp" placeholder="按门票标题搜索">
            <i class="syy icon-chahao" id="clear"></i>
        </div>
    </div>
    <div id="contentBox">
