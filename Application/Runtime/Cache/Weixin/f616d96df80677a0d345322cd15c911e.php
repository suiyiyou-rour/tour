...
<head>
    ...
    <link rel="stylesheet" href="/Public/Weixin/dist/d_ticket.min.css?st=v1.0.1">
...
<body>
    ...
    <div id="reserveMess">
        ...
        <div class="ticket-mess">
            ...
            <p id="tips">温馨提示 : 此产品为有效期模式,购买后在指定有效期内的可用日期都可使用</p>
        </div>
        <div id="ticketNumBox">
            ...
            <div id="peopleNum">
                <div class="num-box">
                    <p class="one-price">
                        ￥
                        <span id="onePrice"></span>/张
                    </p>
                    <div class="select-num">
                        <p class="js_red">
                            <i class="iconfont icon-jianshao"></i>
                        </p>
                        <span id="ticketNum" class="choose-num">1</span>
                        <p class="js_add">
    ...
    <div id="tourristMess" style="display:none">
        ...
        <div id="itemContainer">
            <div id="firstItem">
                ...
                <div class="item-box" id="oneIdentify" style="display:none">
...
<script src="/Public/Weixin/dist/d_ticket.min.js?st=v1.0.2"></script>
