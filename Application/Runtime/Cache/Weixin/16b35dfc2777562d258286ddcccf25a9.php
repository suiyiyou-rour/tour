...
<head>
    ...
    <link rel="stylesheet" href="/Public/Weixin/dist/p_route.min.css?st=v1.0.2">
...
<body>
    ...
    <div id="production">
        <div class="pro-top">
            ...
            <div class="pro-mess">
                <p class="pro-type">出发地 :
                    <span id="beginPlace"></span>
                </p>
                <p class="pro-id">产品ID :
                    <span id="proID"></span>
                </p>
        ...
        <div class="pro-detail">
            ...
            <p id="miaoshuNav" class="item-de">
                <i class="syy icon-miaoshu"></i>产品描述
                <i class="syy icon-xiajiantou"></i>
            </p>
            <div id="miaoshuContent" class="content-box">
...
<script src="/Public/Weixin/dist/p_route.min.js?st=0.0.1?st=v1.0.3"></script>
