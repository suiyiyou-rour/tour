...
class TouristController extends Controller
{
    ...
    public function userRegistShow()
    {
        $this->display();
    }
    ...
    public function userRegister()
    {
        ...
        $result  = M('user') -> where(array('user_account' => $mobile)) -> find();
        if($result){
            $this->ajaxReturn(array('code' => '0', 'msg' => '已经注册'));
        }
        M('sms_code')->where(array('c_code' => $code, 'c_mobile' => $mobile))->delete();
